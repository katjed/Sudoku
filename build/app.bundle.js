...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		var initialBoard = _sudokuUmd2.default.generate('easy', false);
		_this.state = {
	...
	_createClass(App, [{
		...
		value: function checkBoard() {
			var solution = _sudokuUmd2.default.solve(this.state.board);
		...
		value: function solveBoard() {
			var board = _sudokuUmd2.default.solve(this.state.board);
		...
		key: 'onChangeHandler',
		value: function onChangeHandler(index, value) {
			var newBoard = '' + this.state.board.slice(0, index) + value + this.state.board.slice(index + 1);
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: _App2.default.Buttons },
					_react2.default.createElement(
						'button',
						{ onClick: this.checkBoard.bind(this) },
						'Check'
					),
					_react2.default.createElement(
						'button',
						{ onClick: this.newBoard.bind(this) },
						'New game'
					),
					_react2.default.createElement(
						'button',
						{ onClick: this.solveBoard.bind(this) },
						'Solve'
					),
					_react2.default.createElement(
						'button',
...
var _Board = __webpack_require__(40);
...
var Board = function Board(props) {
    var tiles = props.board.split('').map(function (tile, id) {
        var edit = props.initialBoard[id] === '.';
...
var Tile = function Tile(props) {
    ...
    return _react2.default.createElement(
        ...
        edit ? _react2.default.createElement('input', {
            className: _Tile2.default.TileInput,
            type: 'number',
            min: '1',
            max: '9',
            value: props.value == '.' ? '' : props.value,
            onChange: function onChange(e) {
                return props.onChangeHandler(props.index, e.target.value);
            }
...
// module
exports.push([module.i, "._2qtOiCEBCYU2VexccmuC61 {\r\n    flex: 1 1 40px;\r\n    height: 40px;\r\n    line-height: 40px;\r\n    text-align: center;\r\n}\r\n\r\n._1z8B06-69dKW_GLfodHExQ {\r\n    width: 100%;\r\n    height: 100%;\r\n    text-align: center;\r\n}", ""]);

// exports
exports.locals = {
	"Tile": "_2qtOiCEBCYU2VexccmuC61",
	"TileInput": "_1z8B06-69dKW_GLfodHExQ"
};
...
// module
exports.push([module.i, "._1EkDFwFP3qUn0X4Wa-767W {\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    width: 360px;\r\n    height: 360px;\r\n}", ""]);
...
// exports
exports.locals = {
	"App": "_3t9oX_UoSeBfpHTB0oHDRi",
	"Header": "_3gbbF7GZDeNeVKVIOAss8T",
	"Buttons": "_2kwTRYXpjrYMSRcYZOnUhd"
};
